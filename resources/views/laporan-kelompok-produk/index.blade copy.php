            ...
            <form action="{{ route('laporan-kelompok-produk.view') }}"  method="POST">
                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <select name="kode_produk" class="form-control mb-2 my-select" onchange="updateData()">     
                            <option value="">-- Pilih Produk --</option>
                            @foreach($all_produk as $s)
                                <option value="{{ $s->kode_produk }}">{{ $s->kode_produk }} - {{ $s->keterangan }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-12">
