...
use App\Models\SetupPerkiraan;

class SetupPerkiraanController extends Controller
{
    public function index(){

        $setup_akun = SetupPerkiraan::where('status', 'AKTIF')->get();

        return view('setup-akun.index', compact('setup_akun'));
    }
